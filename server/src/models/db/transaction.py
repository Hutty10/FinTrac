...
class Transaction(SQLModel, table=True):
    ...
    category_id: UUID = Field(foreign_key="categories.id", index=True, nullable=True)
    ...
    transaction_date: datetime = Field(..., nullable=False)
    ...
    account: "Account" = Relationship(back_populates="transactions")  # type: ignore # noqa: F821
